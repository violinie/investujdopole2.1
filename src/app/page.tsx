			...
			<div className="max-w-[1220px] mx-auto">
				<div className="grid grid-cols-5 gap-8 my-8">
					<div className="text-white col-span-2 space-y-4">
						...
						<a className="text-2xl" href="tel:+420775972405"><span className="text-[#b4d6a5]">+420</span> 775 972 405</a>

					</div>
					<ul className="grid gap-6">
						<li className="text-white text-lg">O společnosti.</li>
						<li><a href="" className="text-[#afbbd4]">O nás</a></li>
						<li><a href="" className="text-[#afbbd4]">Naše nabídka</a></li>
						<li><a href="" className="text-[#afbbd4]">Kontakt</a></li>
					</ul>
					<ul className="grid gap-6">
						<li className="text-white text-lg">Vzdělávání.</li>
						<li><a href="" className="text-[#afbbd4]">Blog</a></li>
						<li><a href="" className="text-[#afbbd4]">Webinář</a></li>
						<li><a href="" className="text-[#afbbd4]">Newsletter</a></li>
					</ul>
					<ul className="grid gap-6">
						<li className="text-white text-lg">Sledujte nás.</li>
						<li><a href="" className="text-[#afbbd4]">LinkedIn</a></li>
						<li><a href="" className="text-[#afbbd4]">Facebook</a></li>
						<li><a href="" className="text-[#afbbd4]">Instagram</a></li>
					</ul>
				</div>
